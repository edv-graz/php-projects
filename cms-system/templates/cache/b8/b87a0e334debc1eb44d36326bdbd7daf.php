...
/* contact.html */
class __TwigTemplate_bb103a34ba5080eb4d2edd16d4e06c5e extends Template
{
    private $source;
    private $macros = [];
    ...
    <form action=\"";
        ...
        // line 20
        yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["errors"] ?? null), "mail", [], "any", false, false, false, 20), "html", null, true);
        yield "</span>
        </div>
        <div class=\"p-4\">
            ...
            <textarea
                    ...
                    id=\"text\" name=\"text\">";
        // line 26
        yield Twig\Extension\EscaperExtension::escape($this->env, ($context["text"] ?? null), "html", null, true);
        yield "</textarea>
            <span class=\"text-red-500\">";
        // line 27
        yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["errors"] ?? null), "text", [], "any", false, false, false, 27), "html", null, true);
        yield "</span>
        </div>
...
", "contact.html", "/Applications/MAMP/htdocs/templates/contact.html");
    }
}
