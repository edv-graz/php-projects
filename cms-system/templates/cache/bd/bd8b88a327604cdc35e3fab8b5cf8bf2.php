...
class __TwigTemplate_9f566e9404d9194b7feab222ffb4171c extends Template
{
    private $source;
    private $macros = [];
    ...
    <form action=\"";
        ...
        // line 9
        yield Twig\Extension\EscaperExtension::escape($this->env, ($context["doc_root"] ?? null), "html", null, true);
        yield "admin/categories\" type=\"submit\">No</button>
    </form>
</main>
";
        return; yield '';
...
<main class=\"container mx-auto p-10 flex flex-col items-center\">
    <form action=\"{{doc_root}}admin/category-delete/{{id}}\" method=\"post\">
        ...
        <p class=\"text-blue-600 text-2xl mb-4\">Are you sure you want to delete this category?</p>
        <button class=\"bg-pink-600 text-white p-3 rounded-md w-1/3\" type=\"submit\">Yes</button>
        <button class=\"bg-blue-500 text-white p-3 rounded-md w-1/3\" formaction=\"{{doc_root}}admin/categories\" type=\"submit\">No</button>
    </form>
</main>
{% endblock %}", "admin/category-delete.html", "/Applications/MAMP/htdocs/templates/admin/category-delete.html");
    }
}
